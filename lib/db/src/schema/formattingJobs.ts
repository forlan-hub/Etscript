...
export const formattingJobsTable = pgTable("formatting_jobs", {
  ...
  preserveBlankLines: boolean("preserve_blank_lines").notNull().default(true),
  autoDetectStructure: boolean("auto_detect_structure").notNull().default(true),
  preservePageBreaks: boolean("preserve_page_breaks").notNull().default(true),
